...
var (
	...
	metrics = struct {
		...
		messageCache              metric.Int64Gauge
	}{
		...
		messageCache: measurements.Must(meter.Int64Gauge("f3_gpbft_message_cache",
			metric.WithDescription("The number of time GPBFT message cache resulted in hit or miss."))),
	}
)
